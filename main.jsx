...
function App(){
 ...
 const go=async()=>{setBusy(true);setMsg('');try{
  ...
  // V64: restore the exact V51 downstream skin/detail path. This pass changes local RGB micro-contrast only;
  // it does not brighten/re-tone skin and it is identical whether original hair or a selected hairstyle is used.
