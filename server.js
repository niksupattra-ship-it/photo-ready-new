...
GENERATION-STAGE PROPORTION / NECK CONSTRUCTION: Judge the subject's REAL facial width, chin, jaw, ear positions and skull from Image 1, never from the hair reference or transparent padding. Build the new neck directly beneath the existing jaw: a natural width at the jaw-to-neck junction, gradual taper, centered under the chin, and a short visible length suitable for a formal shirt collar. Keep the chin, face plane and eyes in their original perspective: do not project the face forward, enlarge the skull, lengthen the neck, narrow it into a stick, or extend the chin. Balance the GENERATED hairstyle silhouette around the unchanged skull and face; reduce excessive crown/side bulk of the HAIR ONLY, not the face. Hair, ears, jaw and neck must read as a single naturally photographed head, without pasted-on seams. These corrections belong in this AI generation step, NOT a resize, warp or repositioning of the completed portrait.
...
OUTPUT / ANATOMY: centered front-facing ID-photo head, complete hair and ears, plus a short, jaw-proportional, naturally tapered neck with continuous face-to-neck illumination; do not generate shoulders or torso. No shirt, collar, tie, jacket, uniform, epaulettes, insignia, buttons or fabric. Use a simple temporary solid background. Keep natural camera detail without halos or artificial sharpening.
