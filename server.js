...
GOAL: edit a conventional FULLY CLOTHED professional ID portrait of the SAME PERSON. Preserve the original face, hair-reference selection, real skin texture, and normal head/neck proportions. Dress the subject in an ordinary modest WHITE WIDE-OPEN-COLLAR SHIRT: two open collar points spread approximately 10% farther apart than the current wide-open-collar design, with the uppermost button undone and a naturally visible neck and small upper-sternum area inside the shirt opening. The person remains fully dressed. The application will later place its existing fixed clothing template over this result.

NECKLINE COMPLETION: The generated shirt must have a WIDE, OPEN V-SHAPED COLLAR with its two collar edges approximately 10% wider apart than before (width only; do not deepen or lengthen the neckline), not a buttoned-up high collar, blue shirt, turtleneck or scarf. Keep natural continuous skin visible below the chin, along the entire neck and into the modest V opening of the white shirt; the shirt fabric starts at the two collar edges and never covers the center of the V opening. The application will cover the generated shirt with its fixed clothing template; avoid leaving an underlying shirt placket, button, contrasting fabric, white fill, rectangular crop edge or blue-background gap in the central neckline area. Match the original face and neck complexion, skin texture and studio lighting. Keep anatomically normal neck length and a medium-blue studio background. No nudity, bare torso or exposed chest beyond the small conventional open-collar neckline.

GENERATION-STAGE PROPORTION / NECK CONSTRUCTION: Judge the subject's REAL facial width, chin, jaw, ear positions and skull from Image 1, never from the hair reference or transparent padding. Keep the visible neck anatomically proportional under the unchanged jaw and inside the modest wide-open white shirt collar; extend continuous neck skin into the shirt's small V opening without stretching the neck. Do not lengthen the visible chin-to-collar distance, enlarge the head, project the face forward, or narrow the neck. Balance the GENERATED hairstyle silhouette around the unchanged skull and face; reduce excessive crown/side bulk of the HAIR ONLY, not the face. Hair, ears, jaw and neck must read as a single naturally photographed person without pasted-on seams.
...
OUTPUT / ANATOMY: centered front-facing, fully clothed professional ID portrait with complete hair and ears, a naturally proportioned visible neck and a modest white shirt with a wide-open V collar and continuous skin inside its opening. Preserve original framing and keep a medium-blue temporary solid background. Keep natural camera detail without halos or artificial sharpening.
