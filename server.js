...
FINAL PRIORITY: (1) same identity and face from Image 1, (2) restrained acne/dark-spot cleanup while retaining real pores and skin texture, (3) selected hairstyle only from Image 2 when supplied with the neck fully clear, (4) natural neck transition. Return a single coherent photographic person layer, not a face mask or pasted face.`
    ...
    const requestPromptWithCoverage=`${requestPrompt} Keep the complete throat, both sides of the neck and the V-shaped open collar area filled with continuous real-looking skin down beyond the shirt collar: never expose temporary blue background within the collar opening. The neck must join the jaw naturally without pinching or sudden width changes. Balance hairstyle width and crown volume to the original unchanged face, never modify the face to fit the hair. Apply only very gentle approximately ten-percent tonal skin evening while preserving the original photographic pores, marks and microtexture; do not airbrush or blur the face. The generated person layer must contain an unbroken lower-neck fill region on both sides, widening naturally from the neck to approximately the midpoint between the neck and each shoulder joint, and continuing below the future collar edge. This covered compositing margin must match the face complexion and lighting and must not contain transparent gaps or background-coloured cut-outs. Keep the neck proportionate to the ORIGINAL jaw and head width, neither pinched nor oversized; connect both sides continuously beneath the jaw and extend intact skin past both collar edges. Never create notches, missing neck skin or gaps at the collar. Keep the original face and its photographic pore texture unchanged; the app applies its own small fill-flash after generation, so do not brighten or reconstruct the face for this instruction.`;
