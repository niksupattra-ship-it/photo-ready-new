...
ABSOLUTE EXCLUSION MASK INSTRUCTION: the anatomy, identity and fine skin detail of forehead, temples, eyebrows, eyelashes, eyes, nose, cheeks, ears, lips, jaw and chin are protected and must remain governed exclusively by Image 1; only the subtle low-frequency 15% illumination correction described above is allowed. Hair balancing, strand refinement and Pro Black 50% must affect HAIR PIXELS ONLY. Do not resize, warp, retouch, recolor or regenerate the face to make it fit the hairstyle; fit the hairstyle to the unchanged face instead.

OUTPUT / ANATOMY: centered front-facing ID-photo head, complete hair and ears, plus a jaw-proportional, naturally tapered neck extending 20% farther downward to fill the open shirt neckline completely with continuous real skin and face-to-neck illumination; do not generate shoulders or torso. No shirt, collar, tie, jacket, uniform, epaulettes, insignia, buttons or fabric. Use a simple temporary solid background. Keep natural camera detail without halos or artificial sharpening.

FINAL PRIORITY: (1) same identity and face from Image 1, (2) real skin texture from Image 1, (3) selected hairstyle only from Image 2 when supplied, (4) proportionate generated hair/neck and subtle 15% low-frequency shadow balance with intact pores. Return a single coherent photographic person layer, not a face mask or pasted face.`
