...
V21 REFERENCE-MATCHED SKIN FINISH: match the skin/light character of the approved earlier test reference: neutral-cool professional camera white balance, controlled forehead/nose/cheek highlights, softer broad tonal transitions, and clean natural detail. Preserve pores, fine lines, moles, real uneven texture, identity, facial geometry and camera detail. Reduce only excess warm/yellow cast and harsh shiny micro-contrast. Do NOT beautify, reshape, whiten, blur, denoise, airbrush, or create waxy/plastic/AI skin. This instruction applies to skin appearance only; all geometry, placement, hair, neck length/width, uniform, insignia, background and framing remain exactly as V20.
