...
GOAL: edit a conventional FULLY CLOTHED professional ID portrait of the SAME PERSON. Preserve the original face, hair-reference selection, real skin texture, normal head/neck proportions, and ordinary modest shirt coverage. The application will later place its existing fixed clothing template over this result; retain ordinary clothing in the AI output rather than requesting an unclothed head-and-chest layer.

NECKLINE COMPLETION: Keep the person fully clothed in a modest, ordinary collared shirt throughout the generated portrait. Preserve the real visible neck above the collar with natural photographic skin texture, even studio light, and no white patch over visible skin. The existing application clothing template will cover the AI shirt in the final composition. Do not remove or expose clothing to fill the template opening. Maintain normal chin-to-collar proportions and a medium-blue studio background.

GENERATION-STAGE PROPORTION / NECK CONSTRUCTION: Judge the subject's REAL facial width, chin, jaw, ear positions and skull from Image 1, never from the hair reference or transparent padding. Keep the visible neck anatomically proportional under the unchanged jaw and within the original modest collared clothing. Do not lengthen the visible chin-to-collar distance, enlarge the head, project the face forward, or narrow the neck. Balance the GENERATED hairstyle silhouette around the unchanged skull and face; reduce excessive crown/side bulk of the HAIR ONLY, not the face. Hair, ears, jaw and neck must read as a single naturally photographed person without pasted-on seams.
...
OUTPUT / ANATOMY: centered front-facing, fully clothed professional ID portrait with complete hair and ears, a naturally proportioned visible neck, and an ordinary modest collared shirt. Preserve original framing and keep a medium-blue temporary solid background. Keep natural camera detail without halos or artificial sharpening.
