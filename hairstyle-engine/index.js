...
function cacheKey(portrait,mask,reference,hairId,provider){
 return crypto.createHash('sha256').update('v213|gpt-image-1.5|high|high|1024x1536|png|ai-hair-only-face-pixel-lock|')
