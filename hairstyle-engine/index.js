...
function cacheKey(portrait,reference,hairId,provider){
 return crypto.createHash('sha256').update('v192|gpt-image-1.5|high|high|1024x1536|png|neck-clear-pores-retouch|')
