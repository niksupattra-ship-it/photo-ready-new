...
function cacheKey(portrait,reference,hairId,provider){
 return crypto.createHash('sha256').update('v199|gpt-image-1.5|high|high|1024x1536|png|ai-balanced-neck-clavicle|')
...
export async function editHairstyle({portrait,hairId,root=process.cwd(),env=process.env,fetcher=fetch}){
 ...
 form.append('prompt',`STRICT HAIRSTYLE REFERENCE TRANSFER for an ID portrait. Image 1 is the ORIGINAL SUBJECT. Image 2 is ${hairId.startsWith('manhair-')?'the FACELESS transparent hairstyle-only PNG corresponding to the male portrait thumbnail selected in the app':'the EXACT FULL-COLOR THUMBNAIL the user selected in the app, with a model wearing the desired hairstyle'}. The subject in Image 1 MUST remain the same person; do not transfer any reference-model face or clothing. ${styleInstruction} Match Image 2's parting, braid or twist details, fringe, top silhouette, crown height, hair texture, left/right side lengths, and where the hair falls behind the ears and shoulders. The user chose this exact thumbnail, not a generic similar hairstyle. DO NOT default to a smooth tied-back hairstyle or preserve Image 1's old hair when it conflicts with Image 2. No topknot or bun unless visibly present in Image 2. MANDATORY NECK-SKIN CLEARANCE: no strand, braid, ponytail, hair panel or loose end may overlap visible front or side neck skin. Route long hair outside the neck silhouette and behind the shoulders/clothing-template area. Hair ends must taper into individual natural strands, never a straight horizontal or vertical cut line. Preserve Image 1's exact face, skin, pores, eyes, nose, mouth, ears, expression and head placement. Generate one coherent neck in proportion to Image 1: visible chin-to-clavicle length normally around 28–40% of its face height and narrow middle-neck width around 65–80% of its jaw width, adapted to the person's actual anatomy. The neck must taper gently below the jaw, then widen smoothly and symmetrically into both visible clavicles. Keep continuous natural skin from chin through below the clavicles with the same complexion, pores, white balance, shadows and left/right lighting as the face. Never copy the reference model's neck dimensions. No pencil-thin or excessively long neck, abrupt flare, blotches, repeated texture, seam, doubled anatomy or rectangular patch. Do not add any shirt, jacket, black garment, shoulders or insignia. Do not smooth, whiten, recolor or reshape the face. Output one natural coherent photographic head-neck-clavicle portrait with no seams or halos.`);
