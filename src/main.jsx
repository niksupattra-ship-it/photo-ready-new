...
function App(){
 ...
 const changeHair=async id=>{
  ...
  const snap={adjust:{...liveAdjustRef.current},collarWarp:liveCollarWarpRef.current,neckAdjust:{...liveNeckAdjustRef.current}};
